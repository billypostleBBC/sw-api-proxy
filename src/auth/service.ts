...
export class AuthService {
  ...
  async createMagicLink(scope: Scope, email: string): Promise<{ token: string; expiresAt: Date }> {
  ...
  async consumeMagicLink(scope: Scope, token: string): Promise<{ email: string } | null> {
